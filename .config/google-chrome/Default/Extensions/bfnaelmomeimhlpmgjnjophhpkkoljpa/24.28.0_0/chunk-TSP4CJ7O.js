...
`,I=g(U)`
  position: absolute;
  left: 0;
`,Xt=({children:e,items:t,sections:o,icon:s,shouldWrap:d,onIconClick:f,onLeftButtonClick:l,useCloseButton:p})=>{let u=Ie({withCloseButton:p??!1,onLeftButtonClick:l}),m=o&&o.length>0||t&&t.length>0;return i.default.createElement(Be,null,u,i.default.createElement(R,{weight:500,size:22,noWrap:!d,maxWidth:"280px"},e),m||f?i.default.createElement(se,{sections:o,items:t,icon:s||i.default.createElement(W,null),onIconClick:f}):i.default.createElement("div",null))},ue=g(re)`
  position: relative;
  border-bottom: none;
...
//# sourceMappingURL=chunk-TSP4CJ7O.js.map
