...
`,ve=s(K)`
  padding: 8px 16px 8px 12px;
  min-height: 50px;
`,Te=s(v).attrs({size:16,weight:400,lineHeight:19,margin:"0 0 0 8px"})``;c();l();var a=k(P());var ke=s(W)`
  width: 100%;
  position: relative;
`,he=s.div`
  display: inline-flex;
  line-height: 0;
`,Pe=s(({isActive:e,...t})=>a.default.createElement(E,{...t}))`
  padding: 8px 16px 8px 12px;
...
`,Ne=s(K)`
  padding: 8px 16px 8px 12px;
  min-height: 50px;
`,Fe=s(v).attrs({size:16,weight:400,lineHeight:19,margin:"0 0 0 8px"})``,Se=({onChange:e,value:t})=>{let o=ee();return a.default.createElement(ke,{onChange:e,value:t},({isExpanded:d})=>a.default.createElement(a.default.Fragment,null,a.default.createElement(Pe,{isActive:d},a.default.createElement(ye,{networkID:t},a.default.createElement(he,null,a.default.createElement(L,{fill:"#777",width:10})))),a.default.createElement(De,{portal:!1},a.default.createElement(H,{maxHeight:"300px"},o.filter(i=>i!==t).map(i=>a.default.createElement(Ne,{key:i,value:i},a.default.createElement(ye,{networkID:i})))))))},ye=({networkID:e,children:t})=>a.default.createElement(x,{justify:"space-between"},a.default.createElement(x,null,a.default.createElement(V,{networkID:e,size:32}),a.default.createElement(Fe,null,b.getNetworkName(e))),t);var zt=({onClick:e,disabled:t})=>{let{t:o}=y(),d=te();return n.default.createElement(D,{topLeft:{text:o("addAccountImportWalletPrimaryText"),font:"bodyMedium"},bottomLeft:{text:o(d?"addAccountImportWalletSolanaSecondaryText":"addAccountImportWalletSecondaryText")},start:n.default.createElement(N,{backgroundColor:"borderPrimary",color:"textPrimary",icon:"Download",shape:"circle",size:32}),onClick:e,disabled:t})},Ht=({control:e,getValues:t,register:o,setValue:d,trigger:i,errors:p,nameValidations:h,privateKey:m,privateKeyValidations:T,addressPreview:I})=>{let{t:S}=y(),u=ie(C=>C.editableAccountMetadata),A=t("networkID"),w=b.getAddressTypes(A),f=B(),g=f.filter(C=>w.includes(C));return n.default.createElement(le,null,n.default.createElement(U,{name:"networkID",control:e,render:({field:{onChange:C,value:_}})=>f.length===1?n.default.createElement(n.default.Fragment,null):n.default.createElement(Se,{onChange:M=>{C(M);let we=b.getAddressTypes(M),ge=f.filter(xe=>we.includes(xe));d("addressType",ge[0]),m&&i("privateKey")},value:_})}),n.default.createElement(U,{name:"addressType",control:e,render:({field:{onChange:C,value:_}})=>g.length===1?n.default.createElement(n.default.Fragment,null):n.default.createElement(ue,{onChange:M=>{C(M),m&&i("privateKey")},value:_,networkID:A})}),n.default.createElement(j.WithWarning,{placeholder:S("addAccountImportAccountName"),defaultValue:u?.name,warning:!!p.name,warningMessage:p.name?.message,autoComplete:"off",maxLength:oe,...o("name",h)}),n.default.createElement(Ae.WithWarning,{placeholder:S("addAccountImportAccountPrivateKey"),defaultValue:"",warning:!!p.privateKey,warningMessage:p.privateKey?.message,autoComplete:"off",...o("privateKey",T)}),I?n.default.createElement(Me,{label:S("settingsWalletAddress"),pubkey:I}):null)},Me=n.default.memo(({label:e,pubkey:t})=>n.default.createElement(x,{justify:"space-between",align:"center",margin:"-7px 0 0"},n.default.createElement(v,{size:16,weight:600},e),n.default.createElement(v,{size:16},Y(t,4)))),Be=s(j.withComponent("textarea"))`
  height: 120px;
  text-align: start;
  resize: none;
  -webkit-text-security: disc;
`,Ae=pe(Be);Ae.defaultProps={fontSize:"16px"};c();l();var O=k(P());var Ot=({onClick:e,disabled:t})=>{let{t:o}=y(),d=G||q;return O.default.createElement(D,{topLeft:{text:o("addAccountHardwareWalletPrimaryText"),font:"bodyMedium"},bottomLeft:{text:o("addAccountHardwareWalletSecondaryText")},start:O.default.createElement(N,{backgroundColor:"borderPrimary",color:"textPrimary",icon:"WalletHardware",shape:"circle",size:32}),onClick:e,disabled:t||d})};c();l();var X=k(P());var Yt=({onClick:e,disabled:t})=>{let{t:o}=y();return X.default.createElement(D,{topLeft:{text:o("addAccountImportSeedPhrasePrimaryText"),font:"bodyMedium"},bottomLeft:{text:o("addAccountImportSeedPhraseSecondaryText")},start:X.default.createElement(N,{backgroundColor:"borderPrimary",color:"textPrimary",icon:"File",shape:"circle",size:32}),onClick:e,disabled:t})};export{Oe as a,Se as b,zt as c,Ht as d,Ot as e,Yt as f};
//# sourceMappingURL=chunk-FXZSCE5Y.js.map
